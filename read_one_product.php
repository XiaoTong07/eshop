...
<body>
    ...
    <div class="container">
        ...
        try {
            ...
            $query = "SELECT products.id as productid , products.name, description, category, price, promotionprice, manufacturedate, expireddate ,category.id , category.name as catname FROM products INNER JOIN category ON products.category = category.id WHERE products.id = ? LIMIT 0,1";
        ...
        <table class=' table table-hover table-responsive table-bordered'>
            ...
            <tr>
                ...
                <td><?php echo number_format($promotionprice,2);  ?></td>
            </tr>
            <tr>
